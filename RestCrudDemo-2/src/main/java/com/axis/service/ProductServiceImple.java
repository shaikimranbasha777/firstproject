...
public class ProductServiceImple implements ProductService {
	...
	@Override
	public List<Product> getProductPriceLessThen(int productPrice) {
		// TODO Auto-generated method stub
		return productRepository.findByProductPriceLessThen(productPrice);
	}

	@Override
	public List<Product> getProductPriceGreaterThen(int productPrice) {
		// TODO Auto-generated method stub
		return productRepository.findByProductPriceGreaterThen(productPrice);
	}
